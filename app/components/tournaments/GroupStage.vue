...
<template>
  <div v-if="pending" class="flex justify-center py-12"><UIcon name="i-lucide-loader-2" class="animate-spin w-8 h-8 text-blue-500" /></div>
          ...
          <tbody>
            ...
            >
              ...
              <td class="p-3 font-bold">
                <span class="mr-2" :style="{ color: team.colour }">[{{ team.short_sign }}]</span>
                {{ team.name }}
              </td>
