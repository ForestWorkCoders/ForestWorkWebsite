...
counter2.innerHTML = `<span data-purecounter-start="0" data-purecounter-end="` + Math.round((now - then) / (1000 * 60 * 60 * 24)) + `" data-purecounter-duration="1" class="purecounter"></span>`
